...
# OPIRA_MT_INCLUDE_DIR, where to find the headers
...
find_path(OPIRA_MT_INCLUDE_DIR OPIRALibraryMT.h
    PATHS
    NO_DEFAULT_PATH
)
...
find_library(OPIRA_MT_LIBRARY
    NAMES OpiraLibraryMT.lib
    PATHS
    NO_DEFAULT_PATH
)

find_library(OPIRA_MT_ZTHREAD_LIBRARY
    NAMES ZThread.lib
    PATHS
    NO_DEFAULT_PATH
)
...
set(OPIRA_FOUND "NO")
if(OPIRA_INCLUDE_DIR AND OPIRA_OPIRA_LIBRARY AND OPIRA_OCVSurf_LIBRARY AND OPIRA_MT_LIBRARY AND OPIRA_MT_ZTHREAD_LIBRARY)
	set(OPIRA_FOUND "YES")
	set(OPIRA_LIBRARIES
		${OPIRA_OPIRA_LIBRARY}
		...
		${OPIRA_MT_LIBRARY}
		${OPIRA_MT_ZTHREAD_LIBRARY}
	)
	
endif(OPIRA_INCLUDE_DIR AND OPIRA_OPIRA_LIBRARY AND OPIRA_OCVSurf_LIBRARY AND OPIRA_MT_LIBRARY AND OPIRA_MT_ZTHREAD_LIBRARY)
