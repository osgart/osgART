...
osg::Group* createImageBox(osg::Image* video, float boxSize = 40.0f)
{
	osg::Group* node = new osg::Group;

	osgART::VideoGeode* _geode = new osgART::VideoGeode(osgART::VideoGeode::USE_TEXTURE_2D, video);
	
	osg::ShapeDrawable* sd = new osg::ShapeDrawable(new osg::Box(osg::Vec3(0, 0, boxSize), boxSize));
...
osg::Group* createImageSphere(osg::Image* video, float radius = 20.0f)
{
	osg::Group* node = new osg::Group;

	osgART::VideoGeode* _geode = new osgART::VideoGeode(osgART::VideoGeode::USE_TEXTURE_2D, video);
	
	osg::ShapeDrawable* sd = new osg::ShapeDrawable(new osg::Sphere(osg::Vec3(0.0,0.0,-radius),radius));
...
osg::Group* createImageCylinder(osg::Image* video, float radius = 40.0f, float height = 40.0f)
{
	osg::Group* node = new osg::Group;

	osgART::VideoGeode* _geode = new osgART::VideoGeode(osgART::VideoGeode::USE_TEXTURE_2D, video);
	
	osg::ShapeDrawable* sd = new osg::ShapeDrawable(new osg::Cylinder(osg::Vec3(0.0,0.0,0.0),radius,height));
...
int main(int argc, char* argv[]) 
{
	...
	root->addChild(createImageBox(video.get()));

	// Creating a video sphere
	root->addChild(createImageSphere(video.get()));

	// Creating a video cylinder
	root->addChild(createImageCylinder(video.get()));
