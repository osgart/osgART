...
int main(int argc, char* argv[])  {
	...
	if (model!=NULL)
	{
		osg::ref_ptr<osg::MatrixTransform> scaleDownTransfo=new osg::MatrixTransform(osg::Matrix::scale(0.1,0.1,0.1));
		scaleDownTransfo->addChild(model);
		arTransform->addChild(scaleDownTransfo);
	}
	else
	{
